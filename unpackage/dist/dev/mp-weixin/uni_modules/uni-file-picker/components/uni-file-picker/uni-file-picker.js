...
const _sfc_main = {
  ...
  created() {
    if (!(common_vendor.wt.config && common_vendor.wt.config.provider)) {
      this.noSpace = true;
      common_vendor.wt.chooseAndUploadFile = uni_modules_uniFilePicker_components_uniFilePicker_chooseAndUploadFile.chooseAndUploadFile;
    }
  ...
  methods: {
    ...
    chooseFiles() {
      ...
      common_vendor.wt.chooseAndUploadFile({
    ...
    async getTempFileURL(fileList) {
      ...
      const urls = await common_vendor.wt.getTempFileURL(fileList);
